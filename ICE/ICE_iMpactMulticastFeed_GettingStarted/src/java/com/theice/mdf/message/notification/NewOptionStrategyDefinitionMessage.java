...
/**
 * NewOptionStrategyDefinitionMessage
 */
public class NewOptionStrategyDefinitionMessage extends MDSequencedMessageWithMarketID
{
   public static final short FIXED_MESSAGE_LENGTH = 59;
   ...
   public NewOptionStrategyDefinitionMessage()
   {
      MessageType = RawMessageFactory.NewOptionStrategyDefinitionMessageType;
   ...
   public synchronized byte[] serialize()
   {
      ...
      if( SerializedContent == null )
      {
         ...
         //SerializedContent.putInt( super.getMarketID() );
