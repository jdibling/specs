 ...
 */
public class OptionStrategyDefinitionHandler extends AbstractMarketMessageHandler
{
   private static OptionStrategyDefinitionHandler _instance=new OptionStrategyDefinitionHandler();

   private static final Logger logger=Logger.getLogger(OptionsProductDefinitionHandler.class.getName());

   public static OptionStrategyDefinitionHandler getInstance()
   {
      return _instance;
   }

   private OptionStrategyDefinitionHandler()
   {
   }
   ...
   protected void handleMessage(PriceFeedMessage priceFeedMessage)
   {
      ...
      OptionStrategyDefinitionResponse theMessage=(OptionStrategyDefinitionResponse) message;
      ...
      udsMarket=new OptionMarket(theMessage,underlyingMarket);
